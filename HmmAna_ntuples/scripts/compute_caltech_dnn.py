...
def dnn_variables(leading_muon, subleading_muon, leading_jet, subleading_jet, nsoft, j1_qgl, j2_qgl):
    ...
    return ret
def calc_dnn_pred(j1,j2,m1,m2,nsoft,j1_qgl,j2_qgl):
    ...
    model_STDwt = np.load('DNN27vars_sig_vbf_bkg_dyvbf_dy105To160_ewk105To160_split_60_40_mod10_190820.npy')
