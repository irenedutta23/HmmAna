...
void DatavsMC_31July_h_peak_prefit_dnn_pred()
{
  ...
  */
  TString f[77];
  f[0]="fitDiagnosticstest_h_peak_unmasked.root";
  f[1]="fitDiagnosticstest_h_peak_unmasked.root";
  ...
  chname[0]= "h_sideband_dnn_pred_prefit";
  chname[1]= "h_peak_dnn_pred_prefit";
  ...
  for(int j=0;j<2;j++){
    ...
    h_err[j]->GetXaxis()->SetLabelSize(20);
