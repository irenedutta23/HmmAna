...
void DatavsMC_31July_h_sideband()
{
  ...
  */
  ...
  f[1]="fitDiagnosticstest_pt_balance.root";
  ...
  chname[0]= "h_sideband_dijet_inv_mass_prefit";
  chname[1]= "h_sideband_pt_balance_prefit";
  ...
  for(int j=0;j<2;j++){
	...
	//hd[j]->SetBinError(i,sqrt(h_tempdata->GetBinContent(i)));
      }
    }
  ...
  //hd[1]->GetXaxis()->SetRangeUser(0,10);
